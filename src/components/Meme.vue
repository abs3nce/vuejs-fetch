<template>
  <div class="container">
    <div class="inputform">
      <!-- meme select -->
      <select id="memeSelect" class="form-control">
        <option value="10-Guy">10 Guy</option>

        <option value="1950s-Middle-Finger">1950s Middle Finger</option>

        <option value="1990s-First-World-Problems"
          >1990s First World Problems</option
        >

        <option value="1st-World-Canadian-Problems"
          >1st World Canadian Problems</option
        >
        ...
        <option value="Admiral-Ackbar-Relationship-Expert"
          >Admiral Ackbar Relationship Expert</option
        >
        ...
        <option value="Afraid-To-Ask-Andy-Closeup"
          >Afraid To Ask Andy Closeup</option
        >

        <option value="Aint-Nobody-Got-Time-For-That"
          >Aint Nobody Got Time For That</option
        >
        ...
        <option value="Alien-Meeting-Suggestion"
          >Alien Meeting Suggestion</option
        >

        <option value="Alright-Gentlemen-We-Need-A-New-Idea"
          >Alright Gentlemen We Need A New Idea</option
        >
        ...
        <option value="Am-I-The-Only-One-Around-Here"
          >Am I The Only One Around Here</option
        >

        <option value="American-Chopper-Argument"
          >American Chopper Argument</option
        >

        <option value="Ancient-Aliens">Ancient Aliens</option>

        <option value="And-everybody-loses-their-minds"
          >And everybody loses their minds</option
        >
        ...
        <option value="Angry-Chef-Gordon-Ramsay"
          >Angry Chef Gordon Ramsay</option
        >
        ...
        <option value="Annoying-Childhood-Friend"
          >Annoying Childhood Friend</option
        >
        ...
        <option value="Are-Your-Parents-Brother-And-Sister"
          >Are Your Parents Brother And Sister</option
        >
        ...
        <option value="Bernie-I-Am-Once-Again-Asking-For-Your-Support"
          >Bernie I Am Once Again Asking For Your Support</option
        >

        <option value="Beyonce-Knowles-Superbowl"
          >Beyonce Knowles Superbowl</option
        >

        <option value="Beyonce-Knowles-Superbowl-Face"
          >Beyonce Knowles Superbowl Face</option
        >
        ...
        <option value="Big-Bird-And-Mitt-Romney"
          >Big Bird And Mitt Romney</option
        >
        ...
        <option value="Bill-Nye-The-Science-Guy"
          >Bill Nye The Science Guy</option
        >

        <option value="Bill-OReilly">Bill OReilly</option>

        <option value="Billy-Graham-Mitt-Romney"
          >Billy Graham Mitt Romney</option
        >
        ...
        <option value="Blank-Colored-Background"
          >Blank Colored Background</option
        >
        ...
        <option value="Blank-Transparent-Square"
          >Blank Transparent Square</option
        >
        ...
        <option value="Boardroom-Meeting-Suggestion"
          >Boardroom Meeting Suggestion</option
        >
        ...
        <option value="Brace-Yourselves-X-is-Coming"
          >Brace Yourselves X is Coming</option
        >

        <option value="Brian-Burke-On-The-Phone"
          >Brian Burke On The Phone</option
        >

        <option value="Brian-Griffin">Brian Griffin</option>

        <option value="Brian-Williams-Was-There"
          >Brian Williams Was There</option
        >

        <option value="Brian-Williams-Was-There-2"
          >Brian Williams Was There 2</option
        >

        <option value="Brian-Williams-Was-There-3"
          >Brian Williams Was There 3</option
        >
        ...
        <option value="But-Thats-None-Of-My-Business"
          >But Thats None Of My Business</option
        >

        <option value="But-Thats-None-Of-My-Business-Neutral"
          >But Thats None Of My Business Neutral</option
        >
        ...
        <option value="Captain-Phillips-Im-The-Captain-Now"
          >Captain Phillips Im The Captain Now</option
        >
        ...
        <option value="Challenge-Accepted-Rage-Face"
          >Challenge Accepted Rage Face</option
        >
        ...
        <option value="Crazy-Girlfriend-Praying-Mantis"
          >Crazy Girlfriend Praying Mantis</option
        >
        ...
        <option value="Creepy-Condescending-Wonka"
          >Creepy Condescending Wonka</option
        >
        ...
        <option value="Determined-Guy-Rage-Face"
          >Determined Guy Rage Face</option
        >
        ...
        <option value="Donald-Trump-sewing-his-name-into-the-American-Flag"
          >Donald Trump sewing his name into the American Flag</option
        >
        ...
        <option value="Fabulous-Frank-And-His-Snake"
          >Fabulous Frank And His Snake</option
        >

        <option value="Face-You-Make-Robert-Downey-Jr"
          >Face You Make Robert Downey Jr</option
        >
        ...
        <option value="Fast-Furious-Johnny-Tran"
          >Fast Furious Johnny Tran</option
        >
        ...
        <option value="Feels-Bad-Frog---Feels-Bad-Man"
          >Feels Bad Frog Feels Bad Man</option
        >
        ...
        <option value="First-Day-On-The-Internet-Kid"
          >First Day On The Internet Kid</option
        >
        ...
        <option value="First-World-Problems-Cat"
          >First World Problems Cat</option
        >

        <option value="First-World-Stoner-Problems"
          >First World Stoner Problems</option
        >
        ...
        <option value="Give-me-Karma---Beating-the-dead-horse"
          >Give me Karma Beating the dead horse</option
        >
        ...
        <option value="Good-Guy-Socially-Awkward-Penguin"
          >Good Guy Socially Awkward Penguin</option
        >
        ...
        <option value="Grandma-Finds-The-Internet"
          >Grandma Finds The Internet</option
        >
        ...
        <option value="Grumpy-Cat-Does-Not-Believe"
          >Grumpy Cat Does Not Believe</option
        >
        ...
        <option value="Guy-Holding-Cardboard-Sign"
          >Guy Holding Cardboard Sign</option
        >
        ...
        <option value="Happy-Star-Congratulations"
          >Happy Star Congratulations</option
        >
        ...
        <option value="He-Will-Never-Get-A-Girlfriend"
          >He Will Never Get A Girlfriend</option
        >
        ...
        <option value="Hide-Yo-Kids-Hide-Yo-Wife"
          >Hide Yo Kids Hide Yo Wife</option
        >
        ...
        <option value="High-Expectations-Asian-Father"
          >High Expectations Asian Father</option
        >

        <option value="Hillary-Clinton">Hillary Clinton</option>

        <option value="Hillary-Clinton-Cellphone"
          >Hillary Clinton Cellphone</option
        >
        ...
        <option value="Hypocritical-Islam-Terrorist"
          >Hypocritical Islam Terrorist</option
        >
        ...
        <option value="I-Bet-Hes-Thinking-About-Other-Women"
          >I Bet Hes Thinking About Other Women</option
        >
        ...
        <option value="I-Have-No-Idea-What-I-Am-Doing"
          >I Have No Idea What I Am Doing</option
        >

        <option value="I-Have-No-Idea-What-I-Am-Doing-Dog"
          >I Have No Idea What I Am Doing Dog</option
        >
        ...
        <option value="I-Too-Like-To-Live-Dangerously"
          >I Too Like To Live Dangerously</option
        >

        <option value="I-Was-Told-There-Would-Be"
          >I Was Told There Would Be</option
        >

        <option value="I-Will-Find-You-And-Kill-You"
          >I Will Find You And Kill You</option
        >
        ...
        <option value="If-You-Know-What-I-Mean-Bean"
          >If You Know What I Mean Bean</option
        >

        <option value="Ill-Have-You-Know-Spongebob"
          >Ill Have You Know Spongebob</option
        >
        ...
        <option value="Islam-Rage---Angry-Muslim"
          >Islam Rage Angry Muslim</option
        >
        ...
        <option value="Its-True-All-of-It-Han-Solo"
          >Its True All of It Han Solo</option
        >

        <option value="Jack-Nicholson-The-Shining-Snow"
          >Jack Nicholson The Shining Snow</option
        >

        <option value="Jack-Sparrow-Being-Chased"
          >Jack Sparrow Being Chased</option
        >
        ...
        <option value="Jehovas-Witness-Squirrel"
          >Jehovas Witness Squirrel</option
        >
        ...
        <option value="Jesus-Talking-To-Cool-Dude"
          >Jesus Talking To Cool Dude</option
        >
        ...
        <option value="John-Riley-Condescension"
          >John Riley Condescension</option
        >
        ...
        <option value="Keep-Calm-And-Carry-On-Aqua"
          >Keep Calm And Carry On Aqua</option
        >

        <option value="Keep-Calm-And-Carry-On-Black"
          >Keep Calm And Carry On Black</option
        >

        <option value="Keep-Calm-And-Carry-On-Purple"
          >Keep Calm And Carry On Purple</option
        >

        <option value="Keep-Calm-And-Carry-On-Red"
          >Keep Calm And Carry On Red</option
        >
        ...
        <option value="Krusty-Krab-Vs-Chum-Bucket"
          >Krusty Krab Vs Chum Bucket</option
        >

        <option value="Krusty-Krab-Vs-Chum-Bucket-Blank"
          >Krusty Krab Vs Chum Bucket Blank</option
        >
        ...
        <option value="Leonardo-Dicaprio-Cheers"
          >Leonardo Dicaprio Cheers</option
        >

        <option value="Leonardo-Dicaprio-Wolf-Of-Wall-Street"
          >Leonardo Dicaprio Wolf Of Wall Street</option
        >

        <option value="Lethal-Weapon-Danny-Glover"
          >Lethal Weapon Danny Glover</option
        >
        ...
        <option value="Malicious-Advice-Mallard"
          >Malicious Advice Mallard</option
        >
        ...
        <option value="Maroney-And-Obama-Not-Impressed"
          >Maroney And Obama Not Impressed</option
        >
        ...
        <option value="McKayla-Maroney-Not-Impressed"
          >McKayla Maroney Not Impressed</option
        >

        <option value="McKayla-Maroney-Not-Impressed2"
          >McKayla Maroney Not Impressed2</option
        >
        ...
        <option value="Michael-Phelps-Death-Stare"
          >Michael Phelps Death Stare</option
        >
        ...
        <option value="Morgan-Freeman-Good-Luck"
          >Morgan Freeman Good Luck</option
        >
        ...
        <option value="Mr-Black-Knows-Everything"
          >Mr Black Knows Everything</option
        >
        ...
        <option value="Musically-Oblivious-8th-Grader"
          >Musically Oblivious 8th Grader</option
        >
        ...
        <option value="Nicolas-Cage---You-dont-say"
          >Nicolas Cage You dont say</option
        >
        ...
        <option value="No-Bullshit-Business-Baby"
          >No Bullshit Business Baby</option
        >
        ...
        <option value="Oprah-You-Get-A-Car-Everybody-Gets-A-Car"
          >Oprah You Get A Car Everybody Gets A Car</option
        >
        ...
        <option value="Our-Glorious-Leader-Nicolas-Cage"
          >Our Glorious Leader Nicolas Cage</option
        >
        ...
        <option value="Overly-Attached-Girlfriend"
          >Overly Attached Girlfriend</option
        >

        <option value="Overly-Attached-Nicolas-Cage"
          >Overly Attached Nicolas Cage</option
        >
        ...
        <option value="Pentagon-Hexagon-Octagon"
          >Pentagon Hexagon Octagon</option
        >

        <option value="Pepperidge-Farm-Remembers"
          >Pepperidge Farm Remembers</option
        >

        <option value="Perfection-Michael-Fassbender"
          >Perfection Michael Fassbender</option
        >

        <option value="Permission-Bane">Permission Bane</option>

        <option value="Persian-Cat-Room-Guardian"
          >Persian Cat Room Guardian</option
        >

        <option value="Persian-Cat-Room-Guardian-Single"
          >Persian Cat Room Guardian Single</option
        >
        ...
        <option value="Photogenic-College-Football-Player"
          >Photogenic College Football Player</option
        >
        ...
        <option value="Police-Officer-Testifying"
          >Police Officer Testifying</option
        >
        ...
        <option value="Put-It-Somewhere-Else-Patrick"
          >Put It Somewhere Else Patrick</option
        >
        ...
        <option value="Questionable-Strategy-Kobe"
          >Questionable Strategy Kobe</option
        >
        ...
        <option value="Really-Evil-College-Teacher"
          >Really Evil College Teacher</option
        >
        ...
        <option value="Rediculously-Well-Mannered-Athlete"
          >Rediculously Well Mannered Athlete</option
        >
        ...
        <option value="Ridiculously-Photogenic-Guy"
          >Ridiculously Photogenic Guy</option
        >

        <option value="Ridiculously-Photogenic-Judge"
          >Ridiculously Photogenic Judge</option
        >
        ...
        <option value="Roll-Safe-Think-About-It"
          >Roll Safe Think About It</option
        >
        ...
        <option value="Say-That-Again-I-Dare-You"
          >Say That Again I Dare You</option
        >
        ...
        <option value="Scumbag-Daylight-Savings-Time"
          >Scumbag Daylight Savings Time</option
        >
        ...
        <option value="Sexually-Oblivious-Girlfriend"
          >Sexually Oblivious Girlfriend</option
        >

        <option value="Sexually-Oblivious-Rhino"
          >Sexually Oblivious Rhino</option
        >

        <option value="Sexy-Railroad-Spiderman">Sexy Railroad Spiderman</option>

        <option value="Shaq-Only-Smokes-The-Dankest"
          >Shaq Only Smokes The Dankest</option
        >
        ...
        <option value="Short-Satisfaction-VS-Truth"
          >Short Satisfaction VS Truth</option
        >
        ...
        <option value="Shut-Up-And-Take-My-Money-Fry"
          >Shut Up And Take My Money Fry</option
        >
        ...
        <option value="Since-When-Were-You-Under-The-Impression"
          >Since When Were You Under The Impression</option
        >
        ...
        <option value="So-I-Got-That-Goin-For-Me-Which-Is-Nice"
          >So I Got That Goin For Me Which Is Nice</option
        >

        <option value="So-I-Got-That-Goin-For-Me-Which-Is-Nice-2"
          >So I Got That Goin For Me Which Is Nice 2</option
        >

        <option value="So-I-Guess-You-Can-Say-Things-Are-Getting-Pretty-Serious"
          >So I Guess You Can Say Things Are Getting Pretty Serious</option
        >
        ...
        <option value="Socially-Awesome-Awkward-Penguin"
          >Socially Awesome Awkward Penguin</option
        >

        <option value="Socially-Awesome-Penguin"
          >Socially Awesome Penguin</option
        >

        <option value="Socially-Awkward-Awesome-Penguin"
          >Socially Awkward Awesome Penguin</option
        >

        <option value="Socially-Awkward-Couple">Socially Awkward Couple</option>

        <option value="Socially-Awkward-Penguin"
          >Socially Awkward Penguin</option
        >
        ...
        <option value="Spongebob-Ight-Imma-Head-Out"
          >Spongebob Ight Imma Head Out</option
        >
        ...
        <option value="Super-Cool-Ski-Instructor"
          >Super Cool Ski Instructor</option
        >

        <option value="Super-Kami-Guru-Allows-This"
          >Super Kami Guru Allows This</option
        >
        ...
        <option value="Sweaty-Concentrated-Rage-Face"
          >Sweaty Concentrated Rage Face</option
        >
        ...
        <option value="Thats-Just-Something-X-Say"
          >Thats Just Something X Say</option
        >
        ...
        <option value="The-Most-Interesting-Cat-In-The-World"
          >The Most Interesting Cat In The World</option
        >

        <option value="The-Most-Interesting-Justin-Bieber"
          >The Most Interesting Justin Bieber</option
        >

        <option value="The-Most-Interesting-Man-In-The-World"
          >The Most Interesting Man In The World</option
        >
        ...
        <option value="The-Rock-It-Doesnt-Matter"
          >The Rock It Doesnt Matter</option
        >

        <option value="The-Scroll-Of-Truth">The Scroll Of Truth</option>

        <option value="These-Arent-The-Droids-You-Were-Looking-For"
          >These Arent The Droids You Were Looking For</option
        >
        ...
        <option value="Third-World-Skeptical-Kid"
          >Third World Skeptical Kid</option
        >
        ...
        <option value="This-Is-Where-Id-Put-My-Trophy-If-I-Had-One"
          >This Is Where Id Put My Trophy If I Had One</option
        >
        ...
        <option value="Trailer-Park-Boys-Bubbles"
          >Trailer Park Boys Bubbles</option
        >
        ...
        <option value="Unhelpful-High-School-Teacher"
          >Unhelpful High School Teacher</option
        >

        <option value="Unicorn-MAN">Unicorn MAN</option>

        <option value="Unpopular-Opinion-Puffin"
          >Unpopular Opinion Puffin</option
        >
        ...
        <option value="Welcome-To-The-Internets"
          >Welcome To The Internets</option
        >

        <option value="Well-That-Escalated-Quickly"
          >Well That Escalated Quickly</option
        >
        ...
        <option value="Why-Cant-I-Hold-All-These-Limes"
          >Why Cant I Hold All These Limes</option
        >
        ...
        <option value="Wrong-Neighboorhood-Cats"
          >Wrong Neighboorhood Cats</option
        >
        ...
        <option value="Yall-Got-Any-More-Of-That"
          >Yall Got Any More Of That</option
        >
        ...
        <option value="You-Dont-Want-No-Part-Of-This"
          >You Dont Want No Part Of This</option
        >

        <option value="You-Get-An-X-And-You-Get-An-X"
          >You Get An X And You Get An X</option
        >

        <option value="You-Should-Feel-Bad-Zoidberg"
          >You Should Feel Bad Zoidberg</option
        >
        ...
        <option value="You-Underestimate-My-Power"
          >You Underestimate My Power</option
        >

        <option value="You-Were-The-Chosen-One-Star-Wars"
          >You Were The Chosen One Star Wars</option
        >
        ...
        <option value="Zombie-Overly-Attached-Girlfriend"
          >Zombie Overly Attached Girlfriend</option
        >
      ...
      <input type="botText" id="botText" />
      <button type="submit" id="submitButton" @click="changeFormAction">
        GENERATE
      </button>
      <br /><img :src="this.memeurl" alt="" />
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    changeFormAction() {
      let meme = document.getElementById("memeSelect").value;
      let topText = document.getElementById("topText").value;
      let botText = document.getElementById("botText").value;
      let form = this;

      form.action =
        "http://www.apimeme.com/meme?meme=" +
        meme +
        "&top=" +
        topText +
        "&bottom=" +
